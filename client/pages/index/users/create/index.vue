    ...
    <div>
        ...
        >
            ...
            <el-tab-pane label="信息介绍">
                 <markdown-editor :page="page" :originContent="originContent" ref="markdown" :showSaveButton="false"/>
            </el-tab-pane>
    </el-tabs>
...
timing:any;
    ...
    uploadImg(files: File[]){
        let res =  MyUserAPI.uploadImg(MyUserAPI.imgUploadUrl,this.$axios,files[0],this.contentUploadParam).then(res=>{
            if(res.success){
